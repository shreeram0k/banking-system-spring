...
import com.evertz.formbean.AppUserForm;
import com.evertz.model.AppUser;
import com.evertz.model.Gender;
...
public class AppUserDAO {
    ...
    private static void initDATA() {
        ...
        AppUser tonny = new AppUser(1L, "tony", "Tony", "Tony", //
                true, Gender.MALE, "tony@marvel.com", encrytedPassword, "US");
 
        AppUser steven = new AppUser(2L, "steven", "Steven", "Steven", //
                true, Gender.MALE, "steven@marvel.com", encrytedPassword, "US");
 
        USERS_MAP.put(tonny.getUserId(), tonny);
        USERS_MAP.put(steven.getUserId(), steven);
    }
